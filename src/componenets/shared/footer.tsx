...
const Footer = () => {
  return (
    <footer className="footer footer-center bg-neutral text-neutral-content p-6">
      <aside>
        <h2 className="text-lg font-bold tracking-wide">Mahfuzur Rahman</h2>

        <p className="text-sm text-neutral-content/70">
          Full Stack Developer • React • Next.js • Tailwind CSS • DaisyUI
        </p>
      ...
      <nav>
        <h6 className="text-sm font-semibold mb-3 uppercase tracking-[0.2em]">
